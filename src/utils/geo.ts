...
const COUNTRY_CENTROIDS: Record<string, [number, number]> = {
  ...
  BEN: [2.3, 9.3], BDI: [29.9, -3.4], CPV: [-24.0, 16.0], CAF: [21.0, 6.6],
  TCD: [18.7, 15.5], COM: [43.3, -11.9], GNQ: [10.3, 1.7], ERI: [39.8, 15.2],
  SWZ: [31.5, -26.5], GMB: [-15.3, 13.4], GIN: [-9.7, 9.9], GNB: [-15.2, 12.0],
  LSO: [28.2, -29.6], LBR: [-9.4, 6.4], LBY: [17.2, 26.3], MRT: [-10.9, 21.0],
